 ...
 *
*/
// A note for this exercise it would really be best for an actual implementation
// to use the GregorianCalendar class. It offers a more generalizable solution
// Taking into account the historical switch from the Julian to the Gregorian
// and offering it's own isLeapYear() method. However that is probably not
// in the spirit of this rather basic exercise so I'll use the enum classes
// for weekdays and month in the time package and implement by own boolean
// is leap year method.
...
public class Q2_Calendar  {
	...
	private static DayOfWeek printCalendar (Month printMonth, DayOfWeek startDay, 
		...
		// Now get the number of days in this month. Not I am using my own
